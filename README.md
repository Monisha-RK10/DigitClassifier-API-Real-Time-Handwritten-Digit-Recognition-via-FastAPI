...
## Optional: Testing (Manual)
You can manually test the API endpoints without running a server, using the included script: `unit_tests/test_manual.py`
...
### Steps:
  ...
  12. **Use the endpoints:**
      ...
      2. **Predict with Camera Simulation**:
          ...
          3. Returns a simulated prediction from mock_camera_feed images
